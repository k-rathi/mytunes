...
var AppView = Backbone.View.extend({
  ...
  initialize: function(params) {
    ...
    this.currentPlaylistView = new CurrentPlaylistView({collection: this.model.get('currentPlaylist')});
    ...
    // this.model.on('all', function(playlist) {
    //   console.log('event saveplaylist in appview', this);
    // }, this);
